...
def api_request(name):
    ...
    print(f'--documents s3://poctestingpurpose/{name}')
    print(f'--documents s3://poctestingpurpose/{name} --text')
    s.validateInput(f'--documents s3://poctestingpurpose//{name} --text --tables')
    s.run(f'--documents s3://poctestingpurpose/{name} --text --tables')
    print("done")
